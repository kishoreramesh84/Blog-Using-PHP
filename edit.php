	...
	<div class="ui container">
		...
		<form action="createpost.php" method="post" enctype="multipart/form-data" class="ui fluid form">
		  ...
		  <div class="input_field">
		    <input type="text" placeholder="Title" name="title" value="<?php echo $show_title; ?>">
		  </div>
		  <div class="ui divider"></div>
		  <textarea id="editor" name="body" value="<?php echo $show_body; ?>"></textarea>
		        <script>
		                ClassicEditor
		  ...
		  <div class="ui divider"></div>
		  <button class="ui blue button" type="submit" name='update-btn'>Update Post</button>
		</form>	
	</div>
</body>
